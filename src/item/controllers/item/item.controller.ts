...
export class ItemController {
  ...
  // update event by ID
    ...
    async update(@Param('id') item_id: string, @Body() updatedItem: Item): Promise<Item | NotFoundException> {
        try {
  ...
  @Delete(':id')
  @ApiTags('items')
  async remove(@Param('id') item_id: string): Promise<void | NotFoundException> {
        try {

...
export class OrdersController {
    ...
    @ApiResponse({ status: 201, description: 'The order has been successfully created.', type: Orders })
        ...
        examples: {
          item: {
            ...
            value: {
              ...
              itemIds: ["079d8c23-335e-4571-b6c3-499dd9f4806c", "77adf013-f699-4046-9244-a1109dc7b773"]
            },
          },
        },
    })
    ...
    @ApiResponse({ status: 200, description: 'The order has been successfully updated.', type: Orders })
    @ApiResponse({ status: 400, description: 'Bad request' })
